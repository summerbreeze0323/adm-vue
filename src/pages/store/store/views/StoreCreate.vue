    ...
    <div class="card">
      <ValidationObserver ref="store">
        <b-form @submit.prevent>
          ...
          <b-row>
            <div class="col-12 col-md-12">
              ...
              >
                ...
                ></b-form-input>
                <b-button @click="handleAddress">우편번호 찾기</b-button>
          ...
          <div class="btn_wrap">
            <b-button type="button" @click="validAll">메뉴 등록</b-button>
          </div>
        </b-form>
      </ValidationObserver>  
    </div>
...
.store_new {
  ...
  .address {
    ...
    &.no_data { color: #787a7e; }
  }
  .address_detail { margin-top: 6px; }
}
</style>